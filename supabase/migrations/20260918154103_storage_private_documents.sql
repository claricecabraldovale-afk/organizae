-- Organizaê private documents storage bucket and access policies
-- Applied to Supabase project zwakszslarlombcdrhvj on 2026-09-18.

insert into storage.buckets (id, name, public, file_size_limit, allowed_mime_types)
values ('private-documents', 'private-documents', false, 10485760, array['image/jpeg', 'image/png', 'image/webp', 'application/pdf'])
